...
if (!$suspect && !$missing && !$errors) {
  ...
  $user = "$email";
  $usersubject = "Thank you, your form was received";
  $usermessage = "Thank you for your interest in our service. We will be in touch very soon.";
  $userheaders = "From: Pro Painters<painter@hsnyc.co>\r\n";
